...
const showProducts = (products) => {
  ...
  <img class="product-image" src=${image}></img>
    ...
    <h5> <i class="fas fa-users"></i> ${count}</h5>
    <h5> <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i>  ${rate}</h5>
